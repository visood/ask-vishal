...
STRINGS = {
    "en": {
        ...
        "example_questions": [
            ...
            "Walk me through {name}'s career trajectory.",
            "What problems has {name} solved that are hard to solve?",
            "How would {name} add value in the first 90 days?",
            "What is {name}'s leadership or collaboration style?",
            "What domains has {name} worked across?",
            "Tell me something surprising about {name}'s background.",
            "What would {name}'s former colleagues say about working with them?",
        ],
        "job_questions": [
            "How does {name} match this role?",
            "What gaps should {name} address for this position?",
            "Write a cover letter for this role.",
            "What would {name} bring to this team on day one?",
            "How does {name}'s experience map onto the problems in this job?",
        ],
    },
    "fr": {
        "page_title": "le comptoir",
        ...
        "example_questions": [
            ...
            "Retracez le parcours professionnel de {name}.",
            "Quels problèmes complexes {name} a résolus ?",
            "Comment {name} apporterait de la valeur dès les 90 premiers jours ?",
            "Quel est le style de leadership ou de collaboration de {name} ?",
            "Dans quels domaines {name} a travaillé ?",
            "Dites-moi quelque chose de surprenant sur le parcours de {name}.",
            "Que diraient les anciens collègues de {name} ?",
        ],
        "job_questions": [
            ...
            "Qu'apporterait {name} à cette équipe dès le premier jour ?",
            "Comment l'expérience de {name} répond aux enjeux de ce poste ?",
        ],
    },
    "de": {
        "page_title": "le comptoir",
        ...
        "example_questions": [
            ...
            "Beschreiben Sie {name}s beruflichen Werdegang.",
            "Welche schwierigen Probleme hat {name} gelöst?",
            "Wie würde {name} in den ersten 90 Tagen Mehrwert schaffen?",
            "Was ist {name}s Führungs- oder Zusammenarbeitsstil?",
            "In welchen Bereichen hat {name} gearbeitet?",
            "Erzählen Sie etwas Überraschendes über {name}s Hintergrund.",
            "Was würden {name}s ehemalige Kollegen über die Zusammenarbeit sagen?",
        ],
        "job_questions": [
            ...
            "Was würde {name} vom ersten Tag an ins Team einbringen?",
            "Wie passt {name}s Erfahrung zu den Herausforderungen dieser Stelle?",
        ],
    },
}
